/* Title:			NetworkRigidBody.cs
 * Author:			Larry Grant - http://www.3dmuve.com/3dmblog/?p=201
 *
 * Function: 		Used to smooth out networked rigidbody objects being updated via network calls.
 * 
 * Game objects: 	Attached to any rigidbody being updated over the network. ex. Not attached to "your" player, but is attached to all "remote" players.
 * 
 */
